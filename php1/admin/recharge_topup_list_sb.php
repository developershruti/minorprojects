...
//print_r($_POST);
	...
	if(is_array($arr_topup_ids)) {
		...
		if(isset($_REQUEST['Delete']) || isset($_REQUEST['Delete_x']) ){
			...
			$sql = "delete from ngo_users_payment where pay_topupid in ($str_topup_ids) ";
			db_query($sql);
 			$sql_del="delete from ngo_users_recharge where   topup_id in ($str_topup_ids)";
			db_query($sql_del);
...
$columns = "select u_id, u_username, u_fname ,u_address  ,u_email,u_mobile ,u_ref_userid, u_sponsor_id, u_mobile,u_status  ,topup_id ,topup_serialno, topup_code,topup_plan,topup_group,topup_days_for ,topup_rate,topup_amount , topup_datetime ,topup_date ,topup_status ";
...
?>
          ...
          <table width="614" border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                   
                  
                  <td width="86" align="right" style="padding:2px"><input name="Delete" type="image" id="Delete" src="images/buttons/delete.gif" onclick="return  deleteConfirmFromUser('arr_topup_ids[]')"/>                  </td>
                </tr>
              </table>  <br />
