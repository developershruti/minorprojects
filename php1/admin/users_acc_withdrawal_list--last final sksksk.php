...
$sql = " from ngo_users,ngo_users_payment where  u_id=pay_userid and u_status!='Banned' and pay_drcr='Dr' and pay_plan='BANK_WITHDRAW' and pay_status='Unpaid' ";
...
if ($export=='1') {
   $arr_columns =array('u_username'=>'Username','UCASE(u_fname)'=>'ID Name' ,'UCASE(u_bank_acc_holder)'=>'Beneficiary Name' ,'UCASE(u_bank_name)'=>'Bank Name' ,'CONCAT(": ",u_bank_acno)'=>'Account No' ,'UCASE(u_bank_branch)'=>' Branch' ,'UCASE(u_bank_ifsc_code)'=>'IFSC' ,'UCASE(pay_unit)'=>'Type', 'pay_date'=>'Payment Date','UCASE(pay_for)'=>'Payout For' ,'pay_amount'=>'Total Amount' );
...
//,'((sum(topup_amount)/100)*5) as BDF'=>'BDF','((sum(topup_amount)/100)*2) as CWF'=>'CWF'
	//$arr_columns =array( 'u_username'=>'User ID','u_fname'=>'First Name' ,'u_address'=>'Address' ,'u_mobile'=>'Mobile' ,'sum(pay_amount)as totalamount'=>'Total Amount'  );
		...
		$arr_columns =array( 'u_username'=>'User ID','UCASE(u_fname)'=>'ID Name','UCASE(u_bank_acc_holder)'=>'Beneficiary Name', 'sum(pay_amount)as totalamount'=>'Payment Amount'  ,'u_mobile'=>'Mobile','UCASE(u_bank_name)'=>'Bank' ,'UCASE(u_bank_ifsc_code)'=>'Bene IFSC Code' ,'CONCAT(": ",u_bank_acno)'=>'Bene Account Number' ,'UCASE(u_bank_branch)'=>' Branch Address' ,'UCASE(pay_unit)'=>'Type' ,'pay_transfer_date'=>'Transfer Date' );
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td id="pageHead"><div id="txtPageHead"> Confirm Withdrawal Request</div></td>
 </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td id="content"><form method="get" name="form2" id="form2" onsubmit="return confirm_submit(this)">
    <table width="750"  border="0" align="center" cellpadding="2" cellspacing="0" class="tableSearch">
     ...
     <tr>
      ...
      <td align="right">Payment Group </td>
      <td>&nbsp;</td>
     ...
     <tr>
      ...
      <td width="194"><input name="user_id_to" style="width:120px;"type="text" value="<?=$user_id_to?>" />
      </td>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
     </tr>
     ...
     <tr>
      ...
      <td  align="right" valign="top">Get Amount :</td>
 ...
 <!--  <div align="right"><a href="users_payment_create.php">Create Payment</a> | <a href="users_acc_drcr_f.php">Transfer Fund</a></div>-->
   ...
   <form method="post" name="form1" id="form1" onsubmit="confirm_submit(this)">
    <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
     <tr>
      <th width="4%" >Request Pay ID
       <?= sort_arrows('pay_id')?></th>
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      ...
      <td width="9%" align="right" style="padding:2px"><input name="Payout_SMS" type="image" id="Payout_SMS" src="images/buttons/payout_sms.gif" onclick="return sendsmsConfirmFromUser('arr_pay_ids[]')"/>
      </td>
