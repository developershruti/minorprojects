...
///print_r($_POST);
		...
		$total_code = db_scalar("select count(*) from ngo_code where code_id='$u_slno' and code_string='$u_code' and code_is='Available' and  code_cate='1' and code_status='Active' and code_useto>=ADDDATE(now(),INTERVAL 750 MINUTE)");
		...
		//check if there is no error
 		if (count($arr_error_msgs)==0) {
			...
			$message = "WELCOME TO " .SITE_NAME.". ".$u_fname." " .$u_lname." Your Id Number:".$u_username." & PASSWORD ".$u_password.", FOR MORE DETAILS VISIT ".SITE_URL;
...
<? include("top.inc.php");?>
      ...
      <form name="form1" method="post" enctype="multipart/form-data" <?= validate_form()?>>
        <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableForm">
		 ...
		 <!-- <tr>
            <td class="tdLabel">Applying For : </td>
            <td class="tdData"><?
						 //$sql ="select  utype_id, utype_name from ngo_users_type where utype_status='Active'  ";  
						//echo make_dropdown($sql, 'u_utype', $u_utype,  'class="txtfleid" style="width:150px;" alt="select" emsg="Please Select Applying For "', 'Please select');
							?></td>
          </tr>-->
		    <tr>
                         ...
                         <!--   <tr>
                           ...
                           <tr>
                               <td align="left" class="tdLabel">Joining Mode:</td>
                               <td align="left" valign="top" class="maintxt"> <?=join_mode_dropdown('u_join_mode',$u_join_mode,'alt="select" emsg="Please select joining mode"')?></td>
          </tr> 
                            <tr>
                              <td align="left" class="tdLabel">Sl. No<span class="error"> : </span> </td>
                              <td align="left" valign="top" class="maintxt"><input name="u_slno" type="text" class="txtbox" id="u_slno"  value="<?=$u_slno?>" alt="blank" emsg="Please enter Sl No" /></td>
                            </tr>
                            <tr>
                              <td align="left" class="tdLabel">Code No<span class="error">:</span></td>
                              <td align="left" valign="top" class="maintxt"><input name="u_code" type="text" class="textfield" id="u_code" value="<?=$u_code?>" alt="blank" emsg="Please enter  code No" /></td>
                            </tr>
             ...
             <tr>
                        ...
                        <td align="right" valign="top" class="maintxt">DOB<span class="error"> *</span></td>
                        ...
                        <td align="left" valign="top"><span class="maintxt">
                          <input name="u_email" type="text" class="txtbox" id="u_email" style="width:200px;" value="<?=$u_email?>" alt="blank" emsg="Please enter email"/>
                        </span></td>
                      </tr> 
          ...
          <tr>
            <td align="right" class="tdLabel">Security Cde :</td>
          ...
          <tr>
            <td width="169" class="tdLabel">Gender:</td>
          ...
          <tr>
            <td class="tdLabel">Guardian:</td>
            <td class="tdData"><?=guardian_dropdown('u_guardian',$u_guardian)?></td>
          </tr>
          <tr>
            <td class="tdLabel">Guardian name : </td>
          ...
          <tr>
            <td width="140" class="tdLabel">Country:</td>
