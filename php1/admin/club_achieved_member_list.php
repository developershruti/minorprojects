...
///Payout for current selected level count 
   $payout_count = db_scalar("select count(*) from ngo_users_payment where  pay_userid = '$topup_userid' and pay_plan_level='$pay_plan_level' and pay_plan='$pay_group' and pay_group='$pay_group' and pay_date='$payment_date'  ")+0;
	...
	if ($pay_plan_level==1) { $topup_required = 50;}
	else if ($pay_plan_level==2) { $topup_required = 100;}
	else if ($pay_plan_level==3) { $topup_required = 500;}
	else if ($pay_plan_level==4) { $topup_required = 1000;}
	else if ($pay_plan_level==5) { $topup_required = 2500;}
	else if ($pay_plan_level==6) { $topup_required = 5000;}
	else if ($pay_plan_level==7) { $topup_required = 10000;}
	else if ($pay_plan_level==8) { $topup_required = 20000;}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td id="content"><p align="center" style="color:#FF0000;">
            ...
            <div align="right">
              <!--<a href="recharge_topup_add.php">Add New Investment</a>-->
          ...
          border: #ffd000 solid 1px!important; background:#00FF00!important;  cursor:pointer;  color:#333;
              ...
              <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
                <tr>
				  ...
				  <th width="8%" style="background:#875B0B" >Member On <br /> <strong style="background:#FFA500; padding:1px; margin-top:3px;">&nbsp;&nbsp;Level 1&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 2&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 3&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 4&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 5&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 6&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 7&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 8&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level 9&nbsp;&nbsp;</strong></th>
				  <th width="8%" style="background:#875B0B"  >Member <br />On <br /> <strong style="background:#FFA500; padding:1px;">&nbsp;&nbsp;Level&nbsp;10&nbsp;&nbsp;</strong></th>
...
while ($line_raw = mysqli_fetch_array($result)) {
	...
	else if ($topup_amount>30)  { $css = 'td_green';}
  ...
  ?>
                <tr class="<?=$css?>"  >
				  ...
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; font-weight:bold; background:#FFE7BC;"> <?=total_direct_level_downline_ids_paid($u_id,1, $sql_part)+0?>   </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; background:#FFFFFF;  font-weight:bold;"> <?=total_direct_level_downline_ids_paid($u_id,2, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999;  font-weight:bold; background:#FFE7BC;"> <?=total_direct_level_downline_ids_paid($u_id,3, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; background:#FFFFFF;  font-weight:bold;"> <?=total_direct_level_downline_ids_paid($u_id,4, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999;  font-weight:bold;background:#FFE7BC; "> <?=total_direct_level_downline_ids_paid($u_id,5, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; background:#FFFFFF;  font-weight:bold;"> <?=total_direct_level_downline_ids_paid($u_id,6, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999;  font-weight:bold; background:#FFE7BC;"> <?=total_direct_level_downline_ids_paid($u_id,7, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; background:#FFFFFF;  font-weight:bold;"> <?=total_direct_level_downline_ids_paid($u_id,8, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999;  font-weight:bold; background:#FFE7BC;"> <?=total_direct_level_downline_ids_paid($u_id,9, $sql_part)+0?> </td>
				  <td nowrap="nowrap" align="center" style="border:solid 1px #999; background:#FFFFFF;  font-weight:bold;"> <?=total_direct_level_downline_ids_paid($u_id,10, $sql_part)+0?> </td>
                  ...
                  <td nowrap="nowrap"><?=db_scalar("select topup_amount from ngo_users_recharge where topup_userid ='$u_id' order by topup_id desc limit 0,1 ");?> <!--///=$topup_amount--></td>
