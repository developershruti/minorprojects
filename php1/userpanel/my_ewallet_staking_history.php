        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Staking History </h4>
              ...
              <div class="card-body">
                ...
                <table id="scroll-vertical" class="table table-striped  " style="width:100%">
                  <thead class="table-light" >
                    <tr>
                      <th width="13%" align="left">Staking Date </th>
                      <th width="7%" height="23" align="left" >&nbsp;Ref No</th>
                      <th width="19%" align="left"> Staking Amount </th>
					   <th width="19%" align="left"> Txn Hash </th>
					                       </tr>
                  </thead>
                  <?
			...
			$ctr++;
			 ...
			 ?>
                  <tr class="<?=$css?>">
                    ...
                    <td align="left" nowrap="nowrap" ><?=price_format($line['topup_amount']);?>
					 <td align="left" nowrap="nowrap" ><?=$line['topup_code'];?>
                    </td>
                  </tr>
                  <? } ?>
                  <? }  else { ?>
                  <tr   >
                    <td colspan="3" class="smalltxt" align="center" >Staking details not found </td>
                  </tr>
                  <? } ?>
                </table>
