        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0"><?php echo $ARR_WALLET_GROUP[$pay_group] ; ?> Statement</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="javascript: void(0);">My Wallet </a></li>
                  <li class="breadcrumb-item active"><?php echo  $ARR_WALLET_GROUP[$pay_group] ; ?> Statement </li>
                </ol>
              </div>
            </div>
          </div>
...
<br>
			...
			/// AND pay_group='$pay_group'
			 $running_balance =db_scalar("SELECT (SUM(IF(pay_drcr='Cr',pay_amount,''))-SUM(IF(pay_drcr='Dr',pay_amount,''))) as balance FROM ngo_users_ewallet where pay_userid='$_SESSION[sess_uid]' and pay_group='$pay_group'  and pay_id <'$line[pay_id]' ") ;
			 //AND pay_group='$pay_group' and pay_status='Paid'
