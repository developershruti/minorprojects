...
exit();
// Make sure to call exit() after the redirection to stop any further execution of the script exit
                      ...
                      <div class="col-xxl-12">
                        <div class="">
                          <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Play Free Games</h4>
                            ...
                            <div class="card-body">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ps-3">
                                  <h5 class="text-muted text-uppercase fs-13 mb-3"><?=$line_game['game_name'];?> <? //=$line_game['game_id'];?> </h5>
                                </div>
                              </div>
                                <a href="#">
                               <img width="100%" src="<?=$line_game['image'];?>"/>
							   </a>
							   
                            </div>
							<a href="game-play.php?game_id=<?=encryptor('encrypt', $line_game['game_id']);?>" class="btn btn-primary centered mb-3 ">Play</a> 
