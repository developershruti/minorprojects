...
$columns = "select * ";
$sql = " from  ngo_news where  news_status='Active'  "; ///comp_status='Active'  and
  ...
  <div class="dt-root__inner">
        ...
        <div class="dt-content">
          ...
          <app-crypto-dashboard _nghost-ugy-c43="" class="ng-star-inserted">
            <div _ngcontent-ugy-c43="" class="dt-page__header">
              <h1 _ngcontent-ugy-c43="" class="dt-page__title">  Promotional Banners  </h1>
            </div>
	...
	@extract($line);
 	 $css = ($css=='tdOdd')?'tdEven':'tdOdd';
			 ?>
 			  <div _ngcontent-ugy-c43="" class="col-xl-12">
                ...
                <section-balance-portfolio _ngcontent-ugy-c43="" fullheight="" gxcard="" _nghost-ugy-c44="" class="dt-card dt-card__full-height">
                  ...
                  <card-body _ngcontent-ugy-c44="" class="pb-4 dt-card__body" _nghost-ugy-c31="">
                    <div _ngcontent-ugy-c44="" class="row no-gutters" align="center">
					<? if($news_image!='') { ?> <img src="<?=UP_FILES_WS_PATH.'/news/'.$news_image?>" style="width:auto; margin-left:auto; margin-right:auto; " />  <? }?>
				 
                     
                    </div><br>

					<? if($news_image!='') { ?><p align="center"><button _ngcontent-ugy-c44="" class="btn mr-12 btn-sm btn-secondary ng-star-inserted" style="width:20%; margin-left:auto; margin-right:auto;" onclick="window.location='download_file?file=<?=$news_image?>'">&nbsp;Download Now&nbsp;</button>
					 <? }?>
					</p>
